...
module.exports = {
    getListOfCommandKeywords: function (client, guildId) {
        return [
            ...
            client.intlGet(guildId, 'commandSyntaxHiddenVendors'),
            client.intlGet(guildId, 'commandSyntaxHiddenWaterVendors'),
            client.intlGet(guildId, 'commandSyntaxHiddenVendingTime'),
            client.intlGet(guildId, 'commandSyntaxHeli'),
            client.intlGet(guildId, 'commandSyntaxLarge'),
            client.intlGet(guildId, 'commandSyntaxLanguage'),
            ...
            client.intlGet(guildId, 'commandSyntaxLogs'),
            ...
            client.intlGet(guildId, 'commandSyntaxAutoTranslate'),
            ...
            client.intlGet('en', 'commandSyntaxHiddenVendors'),
            client.intlGet('en', 'commandSyntaxHiddenWaterVendors'),
            client.intlGet('en', 'commandSyntaxHiddenVendingTime'),
            client.intlGet('en', 'commandSyntaxHeli'),
            client.intlGet('en', 'commandSyntaxLarge'),
            client.intlGet('en', 'commandSyntaxLanguage'),
            ...
            client.intlGet('en', 'commandSyntaxLogs'),
            ...
            client.intlGet('en', 'commandSyntaxAutoTranslate'),
